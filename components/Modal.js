        ...
        >
            <div className='inline-block align-bottom bg-white rounded-2xl text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-xl sm:w-full'>
                <div className='flex items-center px-1.5 py-2 border-b border-gray-700'>
                    ...
                    >
                        <CloseOutlinedIcon className='h-[22px] text-black' />
                    </div>
                </div>
                    ...
                    <div className='w-full'>
                        <div className='text-[#6e767d] flex gap-x-3 relative'>
                            ...
                            <div>
                                ...
                                <p className='text-[#d9d9d9d] text-[18px] sm:text-base'>
                                    {post?.text}
                                </p>
                            </div>
                        </div>
                            ...
                            <div className='flex-grow mt-2'>
                                ...
                                <div className='flex items-center justify-between pt-2.5'>
                                    <div className='flex items-center'>
                                        <div className='icon'>
                                            <AddAPhotoOutlinedIcon className='text-[#1d9bf0] h-[22px]' />
                                        </div>
                                    ...
                                    <button
                                      className='bg-[#1d9bf0] text-black rounded-full px-4 py-1.5 font-bold shadow-md hover:bg-[#1a8cd8] disabled:hover:bg-[#1d9bf0] disabled:opacity-50 disabled:cursor-default'
                                      type='submit'
                                      onClick={sendComment}
